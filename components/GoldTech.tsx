    ...
    <section className="section gold" id="tecnologia">
      <div className="wrap gold-wrap">
        ...
        <Reveal>
          ...
          <p className="lead">
            La tecnología de ranuras más avanzada en recuperación de oro, desarrollada en
            colaboración con científicos e ingenieros de mina para capturar hasta la
