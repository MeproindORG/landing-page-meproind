    ...
    (async () => {
      try {
        ...
        const GUIDE: GuideEntry[] = [
          ...
          // 5 carrusel — RUEDA hasta posarse ENCIMA de la barra naranja del slide ACTIVO
          ...
          { key: "why", sel: "#comparativa", anchor: ".vfeat-rail", at: (r) => ({ x: Math.max(r.left - 70, 24), y: r.top + r.height * 0.5 }) },
